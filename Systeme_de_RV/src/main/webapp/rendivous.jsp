    ...
    <div class="row">
      <div class="col-lg-12 mt-5">
        <table class="table table-dark">
          ...
          <tbody>
          <%
            List<Rendezvous> rendezvous = (List<Rendezvous>) request.getAttribute("listerendivous");
            for(Rendezvous red : rendezvous){
          ...
          <form action="update" method="POST">
            ...
            <div class="col-lg-6 col-md-6 pt-4">
              <select class="form-select" name="doctorID" aria-label="Default select example">
                <option selected>Selectioner doctor</option>
                <%
